...
export const SEED_USERS: User[] = [
    { id: "cm0000001", name: "Alex Admin", username: "alex", email: "alex@juggler.app", avatar_color: "bg-blue-500" },
    { id: "cm0000002", name: "Sarah Dev", username: "sarah", email: "sarah@juggler.app", avatar_color: "bg-emerald-500" },
    { id: "cm0000003", name: "Mike Manager", username: "mike", email: "mike@juggler.app", avatar_color: "bg-purple-500" },
    { id: "cm0000004", name: "Emily Design", username: "emily", email: "emily@juggler.app", avatar_color: "bg-pink-500" },
];

export const SEED_PROJECTS: Project[] = [
    { p_id: 1, u_id: "cm0000001", name: "Juggler App V1", description: "Launch the MVP of the new todo app.", deadline: "2024-03-15", created_at: "2024-01-01", is_deleted: false },
    { p_id: 2, u_id: "cm0000001", name: "Marketing Q1", description: "Social media and ad campaigns.", deadline: "2024-04-01", created_at: "2024-01-05", is_deleted: false },
];

export const SEED_MEMBERS: ProjectMember[] = [
    { p_id: 1, u_id: "cm0000001", role: 'OWNER' },
    { p_id: 1, u_id: "cm0000002", role: 'MEMBER' },
    { p_id: 2, u_id: "cm0000001", role: 'OWNER' },
];
...
export const SEED_COMMENTS: TaskComment[] = [
    { comment_id: 1, t_id: 2, u_id: "cm0000002", comment_text: "I'll handle the Tailwind config.", created_at: "2024-01-13 10:00:00" }
];

export const SEED_HISTORY: TaskHistory[] = [
    { history_id: 1, t_id: 1, p_id: 1, changed_by: "cm0000001", action_type: "STATUS_CHANGE", old_value: "IN_PROGRESS", new_value: "DONE", created_at: "2024-01-11 14:30:00" }
];
